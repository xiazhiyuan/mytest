...
import test.drools.api.PointRuleEngine;
import test.drools.api.PointRuleEngineImpl;
import test.drools.model.PointDomain;

public class DroolsPointTest extends DroolsBaseTest{
	...
	/**
	 * 运行前需要修改 addPoints.drl
	 *     date-effective "01-Oct-2015"  为"2015-10-01"
    		date-expires "01-Oct-2017"  为"2017-10-01"
	 * @throws IOException
	 */
	@Test
