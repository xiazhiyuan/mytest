package test.concurrent.synchronize.right1.core;

import test.concurrent.synchronize.right1.task.Cinema;
import test.concurrent.synchronize.right1.task.TicketOffice1;
import test.concurrent.synchronize.right1.task.TicketOffice2;
