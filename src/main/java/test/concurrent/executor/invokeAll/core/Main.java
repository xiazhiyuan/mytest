package test.concurrent.executor.invokeAll.core;
...
import test.concurrent.executor.invokeAll.task.Result;
import test.concurrent.executor.invokeAll.task.Task;
